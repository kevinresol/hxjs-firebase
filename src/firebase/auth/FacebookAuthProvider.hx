...
@:jsRequire(#if firebase_admin "firebase-admin" #else "firebase" #end, "auth.FacebookAuthProvider") extern class FacebookAuthProvider implements firebase.auth.AuthProvider {
